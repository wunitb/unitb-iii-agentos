...
| ISC-002 | The duplicate-registration threat and its fail-closed mitigation are recorded as governed build evidence. | `docs/builds/10007-fix-agentos-up-so-a-failed-worker-identity-query/ATTACK_SURFACE.md` and this trace matrix. |

## Required verification

Run `cargo test -p agentos-cli`, `bunx tsc --noEmit`, and `bun test`.
